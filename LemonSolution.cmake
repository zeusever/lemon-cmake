...
function(lemon_project NAME)
  ...
  if(PROJECT_SHARED)
    add_library(${NAME} SHARED ${FILES} ${INFO_FILES} ${PO_FILES} ${LEMON_PROJECT_SOURCES} ${PROJECT_UNPARSED_ARGUMENTS})
  elseif(PROJECT_STATIC)
    add_library(${NAME} STATIC ${FILES} ${INFO_FILES} ${PO_FILES} ${LEMON_PROJECT_SOURCES} ${PROJECT_UNPARSED_ARGUMENTS})
  else()
    add_executable(${NAME} ${PROJECT_UNPARSED_ARGUMENTS} ${FILES} ${INFO_FILES} ${PO_FILES} ${LEMON_PROJECT_SOURCES})
  endif()
